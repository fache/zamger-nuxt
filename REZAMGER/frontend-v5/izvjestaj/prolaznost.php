...
$ispit = intval($_REQUEST['ispit']); // 1 = prvi parc., 2 = drugi p., 3 = broj bodova, 4 = konacna ocjena
...
//				array_push($stud_predmeti_ar,$r200[0]);
		...
		// Konacna ocjena
			...
			if ($studij==-1) 
				...
				$q110 = myquery("select pk.predmet,ko.ocjena from konacna_ocjena as ko, ponudakursa as pk where ko.student=$stud_id and ko.predmet=pk.predmet and ko.akademska_godina=$akgod $studij_upit_pk and pk.akademska_godina=$akgod and $semestar_upit");
			$broj_polozenih=0;
